      ...
      cardContent = (
        ...
        >
          ...
          <div className="p-4 flex flex-col flex-grow">
            ...
            {ad.category && (
              <span className="text-[10px] text-primary uppercase tracking-wider font-semibold mb-1 block">
                {ad.category.name}
              </span>
            )}

            {ad.city && (
              <div className="text-[11px] text-gray-500 dark:text-gray-400 mt-1 flex items-center">
